# this file is only for presentation of the balance game
# http://www.4399.com/flash/206048_2.htm
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if delta_time > period:
            last_time = now_time
            # print(x,y)
            # sim_key_by_time(x, y, thresh=5, period=0.5 * period)
            # sim_key_by_press(x, y, div=10)
            sim_key_by_shortest_hold(x,y,div=45)
